...
AWSBase::AWSBase(QObject *parent) : QObject(parent)
{
}

AWSConnectionBase::AWSConnectionBase(QObject *parent)
    : QObject(parent)
{
...
qint32 AWSConnectionBase::publish(const QMqttTopicName &topic, const QByteArray &content, quint8 qos)
{
...
bool AWSConnectionBase::subscribe(const QMqttTopicFilter &topic, quint8 qos)
{
